...
public class AprobadasTrazabilidadMap extends BasePage {
	...
	protected By btnAprobadas=By.xpath("/html/body/div[1]/main/div/div/section[2]/div[1]/div/div/div[1]/div[2]/div[2]/div[1]/input");
	protected By btnConsultar=By.xpath("//*[@id=\"ConsultaTrazabilidad\"]");
	
	protected By btnExportar=By.xpath("/html/body/div[1]/main/div/div/section[2]/div[2]/div/div/div/div[1]/a");
	...
	protected By txtMes=By.xpath("/html/body/div[5]/form/div[1]/input");//e
	...
	protected By txtDCD=By.xpath("/html/body/div[8]/form/div[1]/input");//50
