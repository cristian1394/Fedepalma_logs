...
public class ReporteCSancionesMap extends BasePage {
	...
	protected By btnReporteCC=By.xpath("/html/body/div[1]/aside/div/section/nav/ul/li[6]/ul/li[13]/a");
	...
	protected By btnEmpieza=By.xpath("/html/body/div[4]/form/div[2]/div/div[2]/ul/li[5]");//a
	...
	protected By btnTermina=By.xpath("/html/body/div[5]/form/div[2]/div/div[2]/ul/li[6]");//5
	...
	protected By btnFiltrarVPalma=By.xpath("/html/body/div[6]/form/div[1]/span/span");
	protected By btnContiene=By.xpath("/html/body/div[6]/form/div[2]/div/div[2]/ul/li[3]");//8
	...
	protected By btnFiltrarVPalmaA=By.xpath("/html/body/div[7]/form/div[1]/span/span");
	protected By btnNoContiene=By.xpath("/html/body/div[7]/form/div[2]/div/div[2]/ul/li[4]");//0
